...
Please manually download the MedQuAD
 dataset and place it under:
...
The resulting medquad_subset.json will be automatically used by the RAG (retrieval) component.
